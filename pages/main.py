...
api_key = "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"
...
class IndividualAnalyzer:
    ...
    def scrap_gpt(self, person_name, key):
        prompt = {
            ...
            "Close_connections": f"Extract Name of 5 influential business people connected with {person_name}. Make sure it should contain only name of the person in bullet point.",
            "Additional_Information": f"Extract any additional information about {person_name} that may be missing from previous sections but is important."
